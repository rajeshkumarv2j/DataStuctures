...
public class BooyerMooreSearchingAlgorithm {
	...
	static void badCharHeuristic(char[] str, int size, int[] badchar) {
		...
		for (i = 0; i < size; i++){
			System.out.println((int) str[i]+".."+i);
			badchar[(int) str[i]] = i;
		}
	}
...
//		char txt[] = "ABC".toCharArray();
//		char txt[] = "ABCABC".toCharArray();
//		char txt[] = "ABCBCA".toCharArray();
//		char txt[] = "ABCCAB".toCharArray();
//		char txt[] = "BCACA".toCharArray();
		char txt[] = "BABABBCABABCABABC".toCharArray();
